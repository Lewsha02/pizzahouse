...
$(window).on('load', function() {
	...
	var imgSprite = $('img[src="img/sprite.png"]');
	var imgCocaCola = $('img[src="img/cocacola.png"]');

	if ( isRetina() && isHighDensity() ) {
		imgSprite.attr('src', 'img/sprite_retina.png');
		imgCocaCola.attr('src', 'img/cocacola_retina.png');
	} else {
		imgSprite.attr('src', 'img/sprite.png');
		imgCocaCola.attr('src', 'img/cocacola.png');
	}
});